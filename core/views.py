...
from core.models import Item, OrderItem, Order, Address, Payment, UserProfile
import stripe
from core.forms import CheckoutForm, PaymentForm
        ...
        try:
            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    print("User is entering a new shipping")
                ...
                messages.info(self.request, "Please fill required fields carefully.")
                return redirect('core:checkout')
        except ObjectDoesNotExist:
